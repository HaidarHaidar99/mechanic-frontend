  ...
  return (
    <footer className="bg-zinc-950 text-zinc-400 border-t border-zinc-900 font-sans transition-colors relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-zinc-900 mt-12 pt-8 flex items-center justify-center text-center text-[10px] font-black uppercase tracking-widest text-zinc-500">
          <p>
